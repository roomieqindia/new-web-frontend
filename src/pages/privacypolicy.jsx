...
import p from "../assets/privacypolicy.svg";
import Logo from "../assets/FinalLogo.png"; // Ensure the path to Logo is correct
...
function CareerPage() {
  ...
  return (
    <div className="sm:h-[1600px] h-[1200px] relative bg-white">
      ...
      {/* Main Content with Privacy Policy Image */}
      <div>
        <img src={p} alt="Privacy Policy" className="h-full w-full relative left-[-10px]" />
      </div>
