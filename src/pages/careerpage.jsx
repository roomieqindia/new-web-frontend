...
// import Logo from "../assets/FinalLogo.png"; // Replace with the correct path to your logo
...
function CareerPage() {
  ...
  return (
    <div className="sm:h-[1600px] h-[1200px] relative bg-white">
      ...
      {/* Main Content with Career Image */}
      <div>
        <img src={career} alt="Career" className="h-full w-full sm:pt-0 pt-11" />
      </div>
